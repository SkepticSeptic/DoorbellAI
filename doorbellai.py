...
def verification(whatis, addmessage=" "): # "oH yOuR VaRiaBLeS aRe sO inConSiStEntLy nAmEd!" it gets worse, trust me
    ...
    while confirmed != 'y' or 'yes': # decided to add yes too for the people that dont know how to read
...
while display.IsStreaming():
	...
	for detection in detections:
        ...
        # error message
				print("Error: Exception occurred during attempted email sending. Try changing server email?") 
